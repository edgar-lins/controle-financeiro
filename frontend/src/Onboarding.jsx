  ...
  async function handleCreateIncome() {
    ...
    try {
      ...
      if (numericIncome > 0) {
        ...
        const carteira = accounts.find(acc => acc.name === "Carteira Geral");
        ...
        <main className="w-full max-w-lg px-8 py-12 relative z-10 text-center">
          ...
          <div className="text-center space-y-6">
            <h1 className="font-headline text-4xl md:text-5xl font-extrabold tracking-tight leading-[1.1] text-on-surface">
              Bem-vindo(a), <span className="text-primary italic">{userName}</span>!
            </h1>
            <p className="font-body text-secondary text-lg leading-relaxed max-w-md mx-auto">
              Vamos configurar seu fluxo em 1 minuto e transformar sua relação com o dinheiro em uma jornada de paz.
            </p>
          </div>
      ...
      <div className="bg-surface text-on-surface font-body min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden">
        ...
        <main className="w-full max-w-2xl flex flex-col items-center space-y-12 z-10">
          ...
          <div className="text-center space-y-4">
            <h1 className="font-headline font-extrabold text-4xl md:text-5xl tracking-tight text-on-surface leading-tight">Tudo pronto!</h1>
            <p className="font-body text-secondary text-lg md:text-xl max-w-md mx-auto leading-relaxed">
              Seu Dashboard já está configurado com a regra <span className="text-primary font-semibold">50/30/20</span>.
            </p>
          </div>
